"""Stable production guards for the microscopic certifier used by all routes."""
...
def test_transverse_components_expose_required_surface() -> None:
    for value in (
...
def test_transverse_parse_reserves_cpu_headroom(monkeypatch) -> None:
...
def test_transverse_modules_have_no_validation_imports() -> None:
    paths = (
