...
- `diagnose_normal_finite_q_response.py`：normal-state finite-q
...
数值稳定性归纳请优先阅读 `validation/reports/validation_summary.md`；
finite-q kernel 状态请阅读
`validation/outputs/response/normal_finite_q_kernel/normal_finite_q_kernel_summary.md`。
