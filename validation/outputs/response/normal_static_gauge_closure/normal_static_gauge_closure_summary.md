...
run_command = `python validation/scripts/numerical_stability/diagnose_normal_static_gauge_closure.py --omega-list 0.0 1e-06 1e-05 0.0001 --nk-list 8 12 16 24 --temperature 30.0 --eta 0.0001 --twist-list 0.001 0.0005 0.0002 --output-prefix /home/liubx25/Ni_Research/Projects/Casimir_Torque_of_LNO327/validation/outputs/response/normal_static_gauge_closure/data/normal_static_gauge_closure`
