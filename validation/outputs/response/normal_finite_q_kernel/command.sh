...
# Outputs under validation/outputs/response/normal_finite_q_kernel/data
...
python validation/scripts/numerical_stability/diagnose_normal_finite_q_response.py \
  ...
  --nk-list 16 24 32 \
  --output-prefix validation/outputs/response/normal_finite_q_kernel/data/normal_finite_q_kernel_full
