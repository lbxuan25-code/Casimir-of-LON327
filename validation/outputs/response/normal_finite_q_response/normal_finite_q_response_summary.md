...
run_command = `python validation/scripts/numerical_stability/diagnose_normal_finite_q_response.py --quick`
quick_mode=True
...
- smallest sampled nonzero q: 0.001
- maximum relative mismatch at smallest nonzero q: 0.630727
- maximum C4 covariance error: 6.07926e-16
