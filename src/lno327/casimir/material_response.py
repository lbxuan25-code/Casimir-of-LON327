...
class MaterialResponsePolicy:
    """Complete physical validation policy for one material response sample."""
    ...
    positive_reality_tolerance: float = 1e-9
    positive_symmetry_tolerance: float = 1e-9
    positive_passivity_tolerance: float = 1e-10
    ...
    def __post_init__(self) -> None:
        ...
        for name in (
            ...
            "positive_reality_tolerance",
            "positive_symmetry_tolerance",
            "positive_passivity_tolerance",
        ):
            object.__setattr__(
                self,
                name,
    ...
    def as_dict(self) -> dict[str, float | str]:
        return {
            ...
            "positive_reality_tolerance": self.positive_reality_tolerance,
            "positive_symmetry_tolerance": self.positive_symmetry_tolerance,
            "positive_passivity_tolerance": self.positive_passivity_tolerance,
        }
...
def build_material_response_sample(
    ...
    *,
    ...
    if not isinstance(policy, MaterialResponsePolicy):
        raise TypeError("policy must be a MaterialResponsePolicy")
    ...
    if xi_eV == 0.0:
        ...
        validation = validate_positive_matsubara_sheet_response(
            response,
            reality_tolerance=policy.positive_reality_tolerance,
            symmetry_tolerance=policy.positive_symmetry_tolerance,
            passivity_tolerance=policy.positive_passivity_tolerance,
        )
