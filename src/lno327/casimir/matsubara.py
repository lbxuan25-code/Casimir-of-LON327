"""Matsubara-frequency helpers owned by the production Casimir layer."""
...
def matsubara_energy_eV(index: int, temperature_K: float) -> float:
    ...
    The zero-frequency value is represented exactly by ``index=0``.  Prime-sum
    weighting is deliberately not applied here; it remains the sole responsibility
    of the Matsubara free-energy reduction.
    """
