...
DEFAULT_CACHE_DIR = ROOT / "outputs" / "cache" / "casimir_local_response" / "response_tensors"
...
def full_run_command(output_prefix: Path = DEFAULT_OUTPUT_PREFIX) -> str:
    ...
    parts = ["python", "scripts/benchmark_casimir_local_response_distance_scan.py"]
    option_map = [
        ("--kinds", "kinds"),
            ...
            rows.append(
                {
                    ...
                    "finite_q_resolved": _parse_bool(row["finite_q_resolved"]),
