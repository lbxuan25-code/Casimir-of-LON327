...
本轮仓库结构已经完成 active / archive 整理。当前 active outputs 只保留阶段报告、
local-response distance scan、finite-q raw q0 consistency；旧 response、normal sampling、
smoke 和中间 Casimir convergence 输出已移动到 `outputs/archive/`，移动清单见
