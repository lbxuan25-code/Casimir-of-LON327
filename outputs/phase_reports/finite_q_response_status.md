...
- `outputs/response/finite_q_anisotropy/`：A4 angular anisotropy 初步诊断。
- `outputs/response/finite_q_local_limit/`：small-q local-limit decomposition。
- `outputs/response/finite_q_formula_consistency/`：vertex、BZ wrapping、denominator、
  overlap 的初步一致性排查。
- `outputs/response/finite_q_subspace_repair/`：near-degenerate subspace projector 与
